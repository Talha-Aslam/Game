    ...
    return Column(
      ...
      children: [
        Row(
          ...
          children: [
            Text(
              hasBoost ? '2X XP ACTIVE' : 'XP Progress',
              style: TextStyle(
                color: hasBoost ? AppColors.mintGreen : AppColors.white30,
                fontSize: 9,
          ...
          child: FractionallySizedBox(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: (hasBoost ? AppColors.mintGreen : AppColors.gold)
      ...
      builder: (_, _) => Container(
        ...
        decoration: BoxDecoration(
          ...
          color: AppColors.mintGreen.withValues(
            alpha: 0.1 + _glow.value * 0.05,
          ),
          border: Border.all(
            color: AppColors.mintGreen.withValues(
              alpha: 0.3 + _glow.value * 0.2,
            ),
          ),
        ),
        child: Text(
