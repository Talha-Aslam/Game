                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        const Text('15,000', style: TextStyle(color: AppColors.cyan, fontSize: 11, fontWeight: FontWeight.w600)),
                      ]),
                    ),
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        ...
                        const SizedBox(width: 4),
                        const Text('250', style: TextStyle(color: AppColors.gold, fontSize: 11, fontWeight: FontWeight.w600)),
                      ]),
                    ),
                  ],
                ),
