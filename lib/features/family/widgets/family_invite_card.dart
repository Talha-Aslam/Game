      ...
      child: Column(
        ...
        children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      '${application.rankName} • ${application.winRate.toStringAsFixed(1)}% WR',
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                if (application.mostPlayedRole != null)
                  _Stat('Role', application.mostPlayedRole!),
              ],
            ),
          ),
          if (application.previousFamilyName != null) ...[
            ...
            Text(
              'Previously: ${application.previousFamilyName}',
              style: TextStyle(
