          ...
          Expanded(
            child: StreamBuilder<List<int>>(
              ...
              builder: (context, snapshot) {
                ...
                // We don't know our own UID generated by Agora accurately here, 
                // but we are definitely local and not in `users` list.
                // We'll use a placeholder '0' for local user.
                final allUsers = [0, ...users];
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    if (isLocal) {
                      ...
                      final account = voiceService.uidMap[uid];
                      if (account != null) {
                        final member = family?.members.firstWhere((m) => m.userId == account, orElse: () => family.members.first);
