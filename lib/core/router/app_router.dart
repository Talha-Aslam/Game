...
class AppRouter {
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/family/create',
        builder: (c, s) => const FamilyCreateScreen(),
      ),
      GoRoute(
        path: '/family/search',
        builder: (c, s) => const FamilySearchScreen(),
      ),
      GoRoute(
        path: '/family/profile',
        builder: (c, s) => const FamilyProfileScreen(),
      ),
      GoRoute(
        path: '/family/chat',
      ...
      GoRoute(
        ...
        builder: (c, s) => const FamilySettingsScreen(),
      ),
      GoRoute(
        path: '/family/spectate',
        builder: (c, s) => const SpectateMatchScreen(),
      ),
